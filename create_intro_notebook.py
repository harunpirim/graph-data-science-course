...
# Introduction to Network Science notebook
intro_cells = [
    {
...
# Create the introduction notebook
print("Creating Introduction to Network Science notebook...\n")
create_notebook("01-introduction-to-network-science.ipynb", "Introduction to Network Science", intro_cells)

print("\nIntroduction notebook created successfully!")
print("\nNext steps:")
print("1. Reorder existing notebooks")
print("2. Update README.md with new order")
