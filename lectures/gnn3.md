...
\alpha_{ij} =
\frac{
    \exp\!\left(\text{LeakyReLU}\!\left(\mathbf{a}^T [\mathbf{W}\mathbf{h}_i \, \| \, \mathbf{W}\mathbf{h}_j]\right)\right)
}{
    \sum_{k \in \mathcal{N}_i}
    \exp\!\left(\text{LeakyReLU}\!\left(\mathbf{a}^T [\mathbf{W}\mathbf{h}_i \, \| \, \mathbf{W}\mathbf{h}_k]\right)\right)
}
\]$$
...
\sigma \!\left(
    \sum_{j \in \mathcal{N}_i}
    \alpha_{ij}^{k} \, \mathbf{W}^{k} \mathbf{h}_j
\right)
\]$$
...
---
Annotations: 0,14779 SHA-256 6d8f659162f1a55905f2  
